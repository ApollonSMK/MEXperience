        ...
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center justify-start h-full">
            <Link href="/" className="flex items-center h-full" prefetch={false}>
              <Image src="https://supabase.me-experience.lu/storage/v1/object/public/images/Logo/logopng.png" alt="M.E Experience Logo" width={112} height={28} className="object-contain" />
            </Link>
          </div>
