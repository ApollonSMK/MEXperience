...
import { updateSubscription } from '@/app/profile/actions';
...
type HomeClientProps = {
    ...
    initialProfile: { subscription_plan: string | null } | null;
}

export function HomeClient({ initialServices, initialUser, initialProfile }: HomeClientProps) {
  const [services, setServices] = React.useState<Service[]>(initialServices);
  const [user, setUser] = React.useState<User | null>(initialUser);
  const [profile, setProfile] = React.useState<{subscription_plan: string | null} | null>(initialProfile);
