...
export async function getAdminData(date?: string) {
  // 1. Create a pure, admin-only Supabase client using the service_role key.
  // This client has no knowledge of user sessions or cookies.
  ...
  // 4. Fetch all profiles to create a lookup map. This also uses the admin client.
