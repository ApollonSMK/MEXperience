      ...
      <main className="flex-grow bg-background">
        <div className="container mx-auto px-4 py-8 md:py-16 max-w-4xl">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none space-y-6 text-foreground/90">
                ...
                <section>
                    <h2 className="text-2xl font-semibold border-b pb-2">2. Objet et Nature des Services</h2>
                ...
                <section>
                    <h2 className="text-2xl font-semibold border-b pb-2">3. Conditions d'Accès et Création de Compte</h2>
                 ...
                 <section>
                    <h2 className="text-2xl font-semibold border-b pb-2">4. Souscriptions, Paiements et Renouvellements</h2>
                ...
                <section>
                    <h2 className="text-2xl font-semibold border-b pb-2">5. Rendez-vous, Annulations et Pénalités</h2>
                    ...
                    <ul className="list-disc list-inside space-y-3 pl-4">
                        <li><strong>Plus de 24 heures d'antecedence :</strong> Droit au remboursement total du montant payé ou à la restitution intégrale des minutes.</li>
                        <li><strong>Dans les 24 heures précédant le rendez-vous :</strong> Remboursement partiel de <u>50 %</u> ou déduction proportionnelle des minutes.</li>
                        <li><strong>Après l'heure prévue ou en cas d'absence ("no-show") :</strong> <u>Perte totale</u> du montant payé et des minutes correspondantes.</li>
                    </ul>
                ...
                <section>
                    <h2 className="text-2xl font-semibold border-b pb-2">6. Droit de Rétractation</h2>
                ...
                <section>
                    <h2 className="text-2xl font-semibold border-b pb-2">7. Garanties, Limitations et Exonérations de Responsabilité</h2>
                 ...
                 <section>
                    <h2 className="text-2xl font-semibold border-b pb-2">8. Obligations du Client</h2>
                ...
                <section>
                    <h2 className="text-2xl font-semibold border-b pb-2">9. Propriété Intellectuelle</h2>
                ...
                <section>
                    <h2 className="text-2xl font-semibold border-b pb-2">10. Suspension et Résiliation du Service</h2>
                ...
                <section>
                    <h2 className="text-2xl font-semibold border-b pb-2">11. Modifications Contractuelles</h2>
                ...
                <section>
                    <h2 className="text-2xl font-semibold border-b pb-2">12. Force Majeure</h2>
                ...
                <section>
                    <h2 className="text-2xl font-semibold border-b pb-2">13. Loi Applicable et Juridiction Compétente</h2>
                ...
                <section>
                    <h2 className="text-2xl font-semibold border-b pb-2">14. Dispositions Finales</h2>
